...
/*
		...
		var halfRezColor : RenderTexture = RenderTexture.GetTemporary (source.width / 1, source.height / 1, 0, rtFormat);			
		var quarterRezColor : RenderTexture = RenderTexture.GetTemporary (source.width / 1, source.height / 1, 0, rtFormat);	
		var secondQuarterRezColor : RenderTexture = RenderTexture.GetTemporary (source.width / 1, source.height / 1, 0, rtFormat);	
		var thirdQuarterRezColor : RenderTexture = RenderTexture.GetTemporary (source.width / 1, source.height / 1, 0, rtFormat);	*/
